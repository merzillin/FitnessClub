      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Edit Protein Details</a>
          </div>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Protein Details</h4>
...
if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
    ...
    include "dbconnect.php";
    $sql="update protein set image='$filename',name='$name',price='$price',url='$url' where id=$id";
    $result=mysqli_query($con,$sql);
    echo "<script>alert('Successfully Inserted')</script>";

  } else {
    $sql="update trainer set name='$name',price='$price',url='$url' where id=$id";
    $result=mysqli_query($con,$sql);
    echo "<script>alert('Successfully Inserted')</script>";
