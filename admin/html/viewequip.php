...
?>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Equipment Details</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">View Equipment Details</h4>
  ...
  while($row=mysqli_fetch_array($result))
  {
      ...
      <tr>
        ...
        <td><a href="editequip.php?id=<?php echo $row["id"]; ?>">change</a> </td>
        <td><a href="deleteequip.php?id=<?php echo $row["id"]; ?>">remove</a></td>
