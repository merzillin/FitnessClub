      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Add Protein</a>
          </div>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Suggested Protein</h4>
...
$sql="insert into protein(image,name,price,url) values('$filename','$name','$price','$url')";
//echo $sql;
...
if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
    echo "The file ". $filename . " has been uploaded.";
    include "dbconnect.php";
    $sql="insert into protein(file,name,price,url) values('$filename','$name','$price','$url')";
    $result=mysqli_query($con,$sql);
    echo "<script>alert('Successfully Inserted')</script>";
