      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Warmup Videos</a>
          </div>
        ...
        <div class="container-fluid">
          <div class="row">
           ...
           <table>
            ...
            <tr><td>URL</td><td><input type="text" name="url" required></td></tr>
            <tr><td>CAPTION</td><td><input type="text" name="caption" required></td></tr>
...
$sql="insert into video(image,url,caption) values('$filename','$url','$caption')";
//echo $sql;
...
if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
    echo "The file ". $filename . " has been uploaded.";
    include "dbconnect.php";
    $sql="insert into video(file,url,caption) values('$filename','$url','$caption')";
    $result=mysqli_query($con,$sql);
    echo "<script>alert('Successfully Inserted')</script>";
