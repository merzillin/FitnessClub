      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Edit Trainer Details</a>
          </div>
  ...
  ?>
      ...
      <td><input type="hidden" name="id" value=<?php echo $row["id"]; ?>>
        <input type="text" name="name" value=<?php echo $row["name"]; ?>></td></tr>
          ...
          <tr><td>phone number</td><td><input type="text" name="phoneno" value="<?php echo $row["phoneno"];?>"></td></tr>
...
if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
    ...
    include "dbconnect.php";
    $sql="update trainer set name='$name',phoneno='$phoneno',image='$filename' where id=$id";
    $result=mysqli_query($con,$sql);
    echo "<script>alert('Successfully Inserted')</script>";

  } else {
    $sql="update trainer set name='$name',phoneno='$phoneno' where id=$id";
    $result=mysqli_query($con,$sql);
    echo "<script>alert('Successfully Inserted')</script>";
