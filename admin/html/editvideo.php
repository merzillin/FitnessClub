...
?>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Edit video Details</a>
          </div>
  ...
  ?>
           ...
           <tr><td>URL</td><td><input type="text" name="url" value="<?php echo $row["url"];?>"></td></tr>
            <tr><td>caption</td><td><input type="text" name="caption" value="<?php echo $row["caption"];?>"></td></tr>
...
if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
    ...
    include "dbconnect.php";
    $sql="update video set image='$filename',url='$url',caption='$caption' where id=$id";
    $result=mysqli_query($con,$sql);
    echo "<script>alert('Successfully Inserted')</script>";
    echo '<meta http-equiv="refresh" content="0;viewvideo.php">';

  } else {
    $sql="update video set url='$url',caption='$caption' where id=$id";
    $result=mysqli_query($con,$sql);
    echo "<script>alert('Successfully Inserted')</script>";
    echo '<meta http-equiv="refresh" content="0;viewvideo.php">';
