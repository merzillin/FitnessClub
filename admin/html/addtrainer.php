      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Trainer Section</a>
          </div>
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
           ...
           <table>
          <tr><td>Trainer Name</td><td><input type="text" name="name" required></td></tr>
          ...
          <tr><td>Course Name</td><td><select name="course">
...
include "../../dbconnect.php";
$sql="insert into trainer(name,phoneno,image,courseid) values('$name','$phone','$filename','$course')";
//echo $sql;
$result=mysqli_query($con,$sql);
...
if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
    echo "The file ". $filename . " has been uploaded.";
    include "dbconnect.php";
    $sql="insert into trainer(name,phoneno,file) values('$name','$phone','$filename')";
    $result=mysqli_query($con,$sql);
    echo "<script>alert('Successfully Inserted')</script>";
